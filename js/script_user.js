...
xmlhttp.onreadystatechange = function () {
  if (this.readyState == 4 && this.status == 200) {
    ...
    document.getElementById("email").innerHTML = "<br />" + "Kontakt do twórców:" + "<br />" + email;
    document.getElementById("nat").innerHTML = "<br />" + "Narodowość: " + narodowosc;
    document.getElementById("dob").innerHTML = "<br />" + "Wiek: " + wiek;
